...
public struct Logger: LoggerType { // changed from fileprivate to public
...
public extension AsyncType {
    public func debug(_ identifier: String? = nil, logger: LoggerType, file: String = #file, line: UInt = #line, function: String = #function, context c: @escaping ExecutionContext = DefaultThreadingModel()) -> Self {
