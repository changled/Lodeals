...
func preAddRestaurants() -> [Restaurant] {
    ...
    let rest1 = Restaurant(name: "High Street", id: "hardcoded1", location: "12490 Palmtag Dr.", tags: ["oh wow", "nice nice", "coo coo", "sandwiches", "American", "deli", "quick foods"], price: 2, deals: [rest1deal1, rest1deal2], alias: "")
    ...
    let rest2 = Restaurant(name: "Sylvester's Burgers", id: "hardcoded2", location: "1099 Santa Ynez Ave, Los Osos, CA 93402", tags: ["Burgers", "American (Traditional)", "Casual", "sandwiches", "American", "deli", "quick foods"], price: 1, deals: [rest2deal1, rest2deal2, rest2deal3], alias: "")
    ...
    let rest3 = Restaurant(name: "Aisuru Sushi", id: "hardcoded3", location: "1023 Monterey St, San Luis Obispo, CA 93401", tags: ["Sushi Bars", "Japanese", "Asian American Fusion"], price: 3, deals: [rest3deal1, rest3deal2, rest3deal3, rest3deal4, rest3deal5, rest3deal6, rest3deal7, rest3deal8, rest3deal9, rest3deal10], alias: "")
    ...
    let rest4 = Restaurant(name: "BAEBITION", id: "hardcoded4", location: "Thugs Cottage", tags: ["Sexy", "Cute", "Smart", "Successful", "Amazing", "Kind"], price: 4, deals: [rest4deal1, rest4deal2, rest4deal3, rest4deal4], alias: "")
    ...
    let rest5 = Restaurant(name: "Ciopinot", id: "hardcoded5", location: "1051 Nipomo St, Steve's Guitar Shoppe, San Luis Obispo, CA 93401", tags: ["Seafood", "Fancy Restaurant"], price: 3, deals: [rest5deal1, rest5deal2], alias: "")
